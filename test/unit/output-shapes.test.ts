...
const DRIVES: Record<string, Drive> = {
  ...
  "custom-view": { args: [UUID] },
  "custom-view create": { args: ["--name", "n", "--type", "issue"] },
  "custom-view delete": { args: [UUID, "--yes"] },
  "custom-view list": { args: [] },
  "custom-view results": { args: [UUID] },
  "custom-view update": { args: [UUID, "--name", "n2"] },
  "custom-view view": { args: [UUID] },
  document: { args: [UUID] },
  ...
  "project-status archive": { args: [UUID, "--yes"] },
  "project-status create": {
    args: ["--name", "n", "--color", "#abcdef", "--position", "1", "--type", "started"],
  },
  "project-status list": { args: [] },
  "project-status unarchive": { args: [UUID] },
  "project-status update": { args: [UUID, "--name", "n2"] },
  "project-status view": { args: [UUID] },
  "project-label create": { args: ["--name", "n"] },
  "project-label delete": { args: [UUID, "--yes"] },
  "project-label list": { args: [] },
  "project-label restore": {
    args: [UUID],
    overrides: { retiredAt: "2026-01-01T00:00:00.000Z" },
  },
  "project-label retire": { args: [UUID, "--yes"] },
  "project-label update": { args: [UUID, "--name", "n2"] },
  "project-label view": { args: [UUID] },
